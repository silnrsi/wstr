...
scrpropsortname: Japanese (alias for Han + Hiragana + Katakana)
---
...
![Han, Hiragana, and Katakana scripts sample](../images/jpan-sample.png "Jacqueline Kaga, 2011.")
...
<ArticlesList tag='script-jpan' header='Related articles' />

<SourceLinksList tag='script-jpan' header='External links' entrytype='online' />

<BibList tag='script-jpan' header='Bibliography' entrytype='non-online' />
