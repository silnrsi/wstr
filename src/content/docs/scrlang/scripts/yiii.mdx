...
:::note
Languages listed as _unwritten_ would likely use Yi script if a writing system were developed. An _obsolete_ value indicates that the writing system is no longer in use for that language; the language may still be spoken.
:::
...
[Full Unicode status information](/scrlang/unicode/yiii-unicode)
