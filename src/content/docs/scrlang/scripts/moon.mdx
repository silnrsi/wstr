...
scrpropsortname: Moon (Moon code, Moon script, Moon type)
---
...
![Moon script sample](../images/moon-sample.jpg)
<CaptionText text="Excerpt from &quot;Dr Moon's Alphabet for the Blind&quot;"/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author="William Moon"
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Moon-type-chart.jpg"
/>
...
<ArticlesList tag='script-moon' header='Related articles' />

<SourceLinksList tag='script-moon' header='External links' entrytype='online' />

<BibList tag='script-moon' header='Bibliography' entrytype='non-online' />
