...
scrpropotcode: egyp
scrpropsortname: Egyptian hieroglyphs
---
...
![Egyptian hieroglyphs script sample](../images/egyp-sample.png)
<CaptionText text="Interesting hieroglyphics at Luxor, Egypt"/>
<Attribution
    type="Image"
    copyholder="watchsmart"
    copyurl=""
    copyyears="2007"
    license="CC BY 2.0"
    ...
    author=""
    source="Flickr"
    sourceurl="https://www.flickr.com/photos/watchsmart/1423164956/in/photostream/"
/>
...
<ArticlesList tag='script-egyp' header='Related articles' />

<SourceLinksList tag='script-egyp' header='External links' entrytype='online' />

<BibList tag='script-egyp' header='Bibliography' entrytype='non-online' />