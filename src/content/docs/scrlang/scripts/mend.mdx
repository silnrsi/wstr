...
![Mende Kikakui script sample](../images/mend-sample.png)
<CaptionText text="&quot;Mɛɛnde yia&quot; in Mende script Kikakui (read from right to left)."/>
<Attribution
    type="Image"
    copyholder="Immanuel Giel"
    copyurl=""
    copyyears="2014"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Mende-yi-a.png"
/>
...
<ArticlesList tag='script-mend' header='Related articles' />

<SourceLinksList tag='script-mend' header='External links' entrytype='online' />

<BibList tag='script-mend' header='Bibliography' entrytype='non-online' />
