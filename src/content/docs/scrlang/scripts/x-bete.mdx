...
![Bété script sample](../images/x-bete-sample.png "Used with permission of Charles Riley. See 'Use and History' tab for more details.")
...
- [Full Unicode status for Bété](/scrlang/unicode/x-bete-unicode)



## Resources

<ArticlesList tag='script-x-bete' header='Related articles' />

<SourceLinksList tag='script-x-bete' header='External links' entrytype='online' />

<BibList tag='script-x-bete' header='Bibliography' entrytype='non-online' />
