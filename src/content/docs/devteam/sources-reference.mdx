...
- For readability each record starts with a new line containing only `-`
- Indentation is two spaces
- Empty fields can be omitted but can also be included with no value (e.g., `pages: `)
- Strings do not need to be quoted unless they contain the special characters `: { } [ ] , & * # ? | - < > = ! % @`

### Example showing all possible fields

```yaml
-
  abstract: "Longer abstract (with special characters)"   
  addendum: Description
  annotation: "Longer annotation (with special characters)"
