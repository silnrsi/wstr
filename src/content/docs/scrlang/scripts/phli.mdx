...
scrpropotcode: phli
scrpropsortname: Inscriptional Pahlavi
---
...
![Inscriptional Pahlavi script sample](../images/phli-sample.png)
<CaptionText text="Detail from Parthian version of the Shapur I inscription at Ka'ba-ye Zartosht."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/w/index.php?curid=66630825"
/>
...
<ArticlesList tag='script-phli' header='Related articles' />

<SourceLinksList tag='script-phli' header='External links' entrytype='online' />

<BibList tag='script-phli' header='Bibliography' entrytype='non-online' />
