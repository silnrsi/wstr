...
scrpropisonumkey: 134 (right-to-left alphabetic)
scrpropotcode: avst
scrpropsortname: Avestan
---
...
![Avestan script sample](../images/avst-sample.png)
<CaptionText text="Text from the Avesta scripture, Yasna 45.II."/>
<Attribution
    type="Image"
...
- [Full Unicode status for Avestan](/scrlang/unicode/avst-unicode)



## Resources

<ArticlesList tag='script-avst' header='Related articles' />

<SourceLinksList tag='script-avst' header='External links' entrytype='online' />

<BibList tag='script-avst' header='Bibliography' entrytype='non-online' />
