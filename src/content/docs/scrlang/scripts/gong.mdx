...
![Gunjala Gondi script sample](../images/gong-sample.jpg)
<CaptionText text="Excerpt from a hand-written primer from 1942"/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
...
<ArticlesList tag='script-gong' header='Related articles' />

<SourceLinksList tag='script-gong' header='External links' entrytype='online' />

<BibList tag='script-gong' header='Bibliography' entrytype='non-online' />
