...
Punctuation was introduced to the script in 1969, based on Latin punctuation. There are also script-hmngific symbols to indicate reduplication, exclamation, the sung or chanted nature of a text, percent, and ampersand. Logographs are used as a grammatical classifier, to denote periods of time, and to indicate clan names, which were historically of great social significance.
