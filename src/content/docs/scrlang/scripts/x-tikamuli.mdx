...
![Tikamuli script sample](../images/x-tikamuli-sample.jpg)
<CaptionText text="'Sunuwar' in Tikamuli script"/>
<Attribution
    type="Image"
    copyholder="Rishu Shukla"
    copyurl=""
    copyyears="2021"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Shukla_Sunuwar_II.svg"
/>
...
<WsList script='x-tikamuli' wsMax='5' />
...
- [Full Unicode status for Tikamuli](/scrlang/unicode/x-tikamuli-unicode)



## Resources

<ArticlesList tag='script-x-tikamuli' header='Related articles' />

<SourceLinksList tag='script-x-tikamuli' header='External links' entrytype='online' />

<BibList tag='script-x-tikamuli' header='Bibliography' entrytype='non-online' />
