...
<details>
<summary>Read the full description...'</summary>Its origin is not known; the shapes of some letters seem to have been based on their  [Arabic](/scrlang/script-qa35) equivalents, but structurally the script resembles a Brahmic abugida.
