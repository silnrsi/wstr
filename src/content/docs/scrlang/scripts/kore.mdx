...
scrpropsortname: Korean (alias for Hangul + Han)
---
...
<ArticlesList tag='script-kore' header='Related articles' />

<SourceLinksList tag='script-kore' header='External links' entrytype='online' />

<BibList tag='script-kore' header='Bibliography' entrytype='non-online' />
