...
Written Armenian contains no script-armnific numbers, rather, each letter was assigned a numeric value. In recent years and particularly in print form, Latin numbers have increasingly been used.
</details>
