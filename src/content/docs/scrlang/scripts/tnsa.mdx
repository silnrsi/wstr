...
![Tangsa script sample](../images/nosample.png)
...
(Note that this script is unrelated to the [Khimhun Tangsa](/scrlang/scripts/x-khimhun-tangsa) script, which is used for writing the same language(s).)
</details>
...
<ArticlesList tag='script-tnsa' header='Related articles' />

<SourceLinksList tag='script-tnsa' header='External links' entrytype='online' />

<BibList tag='script-tnsa' header='Bibliography' entrytype='non-online' />
