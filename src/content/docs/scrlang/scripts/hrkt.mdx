...
![Japanese syllabaries (alias for Hiragana + Katakana "'Katakana' and 'Hiragana' written in their respective scripts.") sample](../images/hrkt-sample.png "'Katakana' and 'Hiragana' written in their respective scripts.")
