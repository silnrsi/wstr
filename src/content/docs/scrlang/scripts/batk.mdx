...
![Batak script sample](../images/batk-sample.png)
<CaptionText text="Text from the Batak scripture, John 3:16."/>
<Attribution
    type="Image"
...
<ArticlesList tag='script-batk' header='Related articles' />

<SourceLinksList tag='script-batk' header='External links' entrytype='online' />

<BibList tag='script-batk' header='Bibliography' entrytype='non-online' />
