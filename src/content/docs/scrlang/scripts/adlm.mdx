...
<ArticlesList tag='script-adlm' header='Related articles' />

<SourceLinksList tag='script-adlm' header='External links' entrytype='online' />

<BibList tag='script-adlm' header='Bibliography' entrytype='non-online' />
