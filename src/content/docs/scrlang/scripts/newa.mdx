...
![Newa script sample](../images/nosample.png)
...
<details>
<summary>Read the full description...</summary>This script has also been used, extensively in some cases, for writing the Sanskrit, Nepali, Hindi, Bengali, and Maithili languages (see [Languages written with Newa, Newar, Newari, Nepāla lipi script](/scrlang/langlist/newa-langs)). The script is also known as Nepalakshar, Newah Akhah and Pachumol. It is one of six scripts subsumed under the name Nepal-Lipi, literally 'Nepal-Script', though it is not to be confused with Devanagari, which is the script normally used for writing Nepali.
...
- [Unicode status for Bhujinmol](/scrlang/unicode/x-bhujinmol-unicode)
