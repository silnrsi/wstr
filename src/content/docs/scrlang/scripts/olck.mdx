...
scrpropotcode: olck
scrpropsortname: Ol Chiki (Ol Cemet, Ol, Santali)
---
...
![Ol Chiki script sample](../images/olck-sample.png "Braja Mohan Murmu via cititribe, 2011.")
...
<ArticlesList tag='script-olck' header='Related articles' />

<SourceLinksList tag='script-olck' header='External links' entrytype='online' />

<BibList tag='script-olck' header='Bibliography' entrytype='non-online' />
