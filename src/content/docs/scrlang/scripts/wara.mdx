...
scrpropotcode: wara
scrpropsortname: Warang Citi (Varang Kshiti)
---
...
![Warang Citi script sample](../images/wara-sample.png)
<CaptionText text="Warang Citi sample"/>
<Attribution
    type="Image"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Shukla_Warang_Citi_Uppercase.svg"
/>
...
<ArticlesList tag='script-wara' header='Related articles' />

<SourceLinksList tag='script-wara' header='External links' entrytype='online' />

<BibList tag='script-wara' header='Bibliography' entrytype='non-online' />
