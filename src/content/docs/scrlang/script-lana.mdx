...
<details>
<summary>Read the full description...'</summary>It has been used for writing the Northern Thai, Lü and Khün languages. Northern Thai is the biggest language group which uses the script, with 6million speakers, but literacy is low. Lü is now written in the [New Tai Lue](/scrlang/script-lana) script, although some speakers born before 1950 are still literate in Lanna. The script has religious significance and is used in Buddhist monasteries.
