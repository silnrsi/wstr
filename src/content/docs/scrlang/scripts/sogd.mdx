...
![Sogdian script sample](../images/sogd-sample.jpg)
<CaptionText text="Sogdian Manichaean creditor letter from the 9th–13th century, Bezeklik Caves."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Sogdian_text_Manichaean_letter.jpg"
/>
...
- [Full Unicode status for Sogdian](/scrlang/unicode/sogd-unicode)



## Resources

<ArticlesList tag='script-sogd' header='Related articles' />

<SourceLinksList tag='script-sogd' header='External links' entrytype='online' />

<BibList tag='script-sogd' header='Bibliography' entrytype='non-online' />
