...
<ArticlesList tag='script-qaao' header='Related articles' />

<SourceLinksList tag='script-qaao' header='External links' entrytype='online' />

<BibList tag='script-qaao' header='Bibliography' entrytype='non-online' />
