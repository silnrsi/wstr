...
scrpropotcode: sarb
scrpropsortname: Old South Arabian
---
...
![Old South Arabian script sample](../images/sarb-sample.jpg)
<CaptionText text="Blocks bearing inscriptions in the Sabaean language, northern Ethiopia"/>
<Attribution
    type="Image"
    copyholder="A. Davey"
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Ancient_Blocks_With_Sabaean_Inscriptions,_Yeha,_Ethiopia_(3146498586).jpg"
/>
...
<ArticlesList tag='script-sarb' header='Related articles' />

<SourceLinksList tag='script-sarb' header='External links' entrytype='online' />

<BibList tag='script-sarb' header='Bibliography' entrytype='non-online' />
