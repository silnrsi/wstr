...
tags: [script-arab, char-0620, char-0650 char-0652, char-0654, char-065F, char-06C4, char-06F4, char-06F6, char-06F7, lang-ks]
lastUpdated: 2026-08-12
---

Kashmiri is generally written in the Nastaliq style of Arabic script and follows the Urdu letter design. The examples below describe display of some Kashmiri characters using Nastaliq style in the first line and Naskh in the second line.
...
:usv[065F]{usv char name} was also added for the Kashmiri language.

![Kashmiri wavy hamza](images/arab-kashmiri-wavy-hamza.png)
