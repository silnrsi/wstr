...
![Tafi script sample](../images/x-hausa-tafi-sample.png "Tafi Writing in Hausa")
...
<WsList script='x-hausa-tafi' wsMax='5' />
...
- [Full Unicode status for Tafi](/scrlang/unicode/x-hausa-tafi-unicode)



## Resources

<ArticlesList tag='script-x-hausa-tafi' header='Related articles' />

<SourceLinksList tag='script-x-hausa-tafi' header='External links' entrytype='online' />

<BibList tag='script-x-hausa-tafi' header='Bibliography' entrytype='non-online' />
