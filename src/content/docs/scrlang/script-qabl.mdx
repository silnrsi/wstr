...
This script is likely an appropriation of [Brahmi](/scrlang/script-qabl).

_This script is suspected to be one way that the Eastern Magar language is written. 
