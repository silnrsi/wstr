...
Please note that, although the Tai Viet script does exhibit reordering behaviour, that reordering is not typically reflected in software implementations. See [Syllable Structure and Reordering in Tai Viet](https://scriptsource.org/entry/ca53syu3cl) or [Reordering and Data Storage Order](/articlelib/r/reordering-and-data-storage-order) for more details.
</details>
