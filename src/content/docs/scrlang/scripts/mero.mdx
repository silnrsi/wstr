...
scrpropotcode: mero
scrpropsortname: Meroitic Hieroglyphs
---
...
![Meroitic hieroglyphs script sample](../images/mero-sample.png)
<CaptionText text="Grafiktafel für den Unicodeblock Meroitische Hieroglyphen"/>
<Attribution
    type="Image"
    copyholder="ÅñtóñSûsî (Ð)"
    copyurl=""
    copyyears="2013"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:UCB_Meroitic_Hieroglyphs.png"
/>
...
<ArticlesList tag='script-mero' header='Related articles' />

<SourceLinksList tag='script-mero' header='External links' entrytype='online' />

<BibList tag='script-mero' header='Bibliography' entrytype='non-online' />
