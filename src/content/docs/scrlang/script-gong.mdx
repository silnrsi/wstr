...
<details>
<summary>Read the full description...'</summary>The script is used to write the Gondi language and is distinct from the [Masaram Gondi](/scrlang/script-gong) script designed in 1928 by Munshi Mangal Singh Masaram.
