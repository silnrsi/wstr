...
![Telugu script sample](../images/telu-sample.png "karikīkaṭ (Let us Read), via Gondwana, 2008.")
...
<ArticlesList tag='script-telu' header='Related articles' />

<SourceLinksList tag='script-telu' header='External links' entrytype='online' />

<BibList tag='script-telu' header='Bibliography' entrytype='non-online' />
