...
scrpropotcode: sind
scrpropsortname: Khudawadi, Sindhi
---
...
![Khudawadi, Sindhi script sample](../images/sind-sample.png)
<CaptionText text="Sindhi word for Turban, written in Khudawadi script "/>
<Attribution
    type="Image"
    copyholder="Vikram Nankani"
    copyurl=""
    copyyears="2019"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Thari_Patko(Turban).svg"
/>
...
<ArticlesList tag='script-sind' header='Related articles' />

<SourceLinksList tag='script-sind' header='External links' entrytype='online' />

<BibList tag='script-sind' header='Bibliography' entrytype='non-online' />
