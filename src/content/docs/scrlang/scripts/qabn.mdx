...
<ArticlesList tag='script-qabn' header='Related articles' />

<SourceLinksList tag='script-qabn' header='External links' entrytype='online' />

<BibList tag='script-qabn' header='Bibliography' entrytype='non-online' />
