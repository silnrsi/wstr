...
<details>
<summary>Read the full description...'</summary>Tikamuli is used primarily in Nepal, and [Jenticha](/scrlang/script-qa19) is used primarily in Sikkim. In both places, Sunuwar can also be written in the [Devanagari](/scrlang/script-Deva) script.
