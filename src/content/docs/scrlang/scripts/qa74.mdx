...
![Bhujinmol sample](../images/qa74-sample.jpg "Detail from Sanskrit manuscript written using Bhujimol script")
...
- [Full Unicode status for Bhujinmol](/scrlang/unicode/qa74-unicode)



## Resources

<ArticlesList tag='script-qa74' header='Related articles' />

<SourceLinksList tag='script-qa74' header='External links' entrytype='online' />

<BibList tag='script-qa74' header='Bibliography' entrytype='non-online' />
