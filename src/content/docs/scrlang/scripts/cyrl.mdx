...
Data indicating how characters are used to represent sounds is available for the following languages as written with Cyrillic script:

- [Russian](/scrlang/graphemes/ru-cyrl)

<SourceLinksList tag='script-cyrl' header='External links' entrytype='online' />

<BibList tag='script-cyrl' header='Bibliography' entrytype='non-online' />
