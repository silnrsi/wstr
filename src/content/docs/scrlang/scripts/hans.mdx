...
scrpropsortname: Han (Simplified variant)
---
...
<ArticlesList tag='script-hans' header='Related articles' />

<SourceLinksList tag='script-hans' header='External links' entrytype='online' />

<BibList tag='script-hans' header='Bibliography' entrytype='non-online' />
