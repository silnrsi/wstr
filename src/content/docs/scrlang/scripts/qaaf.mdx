...
<ArticlesList tag='script-qaaf' header='Related articles' />

<SourceLinksList tag='script-qaaf' header='External links' entrytype='online' />

<BibList tag='script-qaaf' header='Bibliography' entrytype='non-online' />
