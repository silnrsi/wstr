...
Content indicated as being in the "Public Domain" meets, to the best of our knowledge, age and authorship standards for that status, even though such standards differ between jurisdictions. Whenever possible we have linked to the source of that content which gives more detailed information. Please consult those individual sources before reusing "Public Domain" content.
