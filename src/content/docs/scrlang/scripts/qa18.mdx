...
![Tafi script sample](../images/qa18-sample.png "Tafi Writing in Hausa")
...
<ArticlesList tag='script-qa18' header='Related articles' />

<SourceLinksList tag='script-qa18' header='External links' entrytype='online' />

<BibList tag='script-qa18' header='Bibliography' entrytype='non-online' />
