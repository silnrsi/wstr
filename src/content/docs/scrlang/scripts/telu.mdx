...
![Telugu sample](../images/telu-sample.png "karikīkaṭ (Let us Read), via Gondwana, 2008. See Use and History subject area.")
...
[comment]: # ( ![unknown image](../images/telu-TeluguConjuncts.png) )
...
[comment]: # ( ![unknown image](../images/telu-TeluguVIS.png) )
