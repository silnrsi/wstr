...
![Tagbanwa script sample](../images/tagb-sample.png)
<CaptionText text="Sample of Tagbanwa script."/>
<Attribution
    type="Image"
...
<ArticlesList tag='script-tagb' header='Related articles' />

<SourceLinksList tag='script-tagb' header='External links' entrytype='online' />

<BibList tag='script-tagb' header='Bibliography' entrytype='non-online' />
