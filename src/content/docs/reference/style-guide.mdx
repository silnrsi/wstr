...
For internal links use only explicit paths from the `src/content/docs` base directory without the `.md` extension. Do not use relative paths like `./filename` or `../filename`. Examples of good links:

- `/reference/glossary`
- `/topics/analysis/unicode-bidi-algorithm`
- `/topics/layout/justification`
- `/scrlang/script-tavt`
