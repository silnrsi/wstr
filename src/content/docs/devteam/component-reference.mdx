...
|Property|Description|
|---|---|
|slots| The text to display as the caption, use basic markdown to add extra styling. |
...
```html
<Caption>
  This is the caption text and _may_ include **basic** 
  [markdown](https://www.markdownguide.org/) styling.
</Caption>
```
