...
![Jurchen script sample](../images/jurc-sample.jpg)
<CaptionText text="Detail from copy of medallion with Jurchen inscription."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Bushell_Juchen_21.jpg"
/>
...
The Jurchen script has been accepted for encoding in a future version of the Unicode Standard.
...
<SourceLinksList tag='script-jurc' header='External links' entrytype='online' />

<BibList tag='script-jurc' header='Bibliography' entrytype='non-online' />
