...
scrpropisocode: 292 (left-to-right alphabetic)
...
Sarati was created partly to provide a history for the better-known [Tengwar](https://scriptsource.org/cms/scripts/page.php?item_id=script_detail&uid=g23d9a269f) script, which is claimed to be the descendant of Sarati.
</details>
