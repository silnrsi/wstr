...
scrpropotcode: newa
scrpropsortname: Newa, Newar, Newari, Nepala lipi
---
...
![Newa script sample](../images/newa-sample.png "Adam Holloway, 2011.")
...
<details>
<summary>Read the full description...</summary>This script has also been used, extensively in some cases, for writing the [Sanskrit](https://scriptsource.org/ws/sa-Newa), [Nepali](https://scriptsource.org/ws/ne-Newa), [Hindi](https://scriptsource.org/ws/hi-Newa), [Bengali](https://scriptsource.org/ws/bn-Newa), and [Maithili](https://scriptsource.org/ws/mai-Newa) languages. The script is also known as Nepalakshar, Newah Akhah and Pachumol. It is one of six scripts subsumed under the name Nepal-Lipi, literally 'Nepal-Script', though it is not to be confused with Devanagari, which is the script normally used for writing Nepali.
...
<ArticlesList tag='script-newa' header='Related articles' />

<SourceLinksList tag='script-newa' header='External links' entrytype='online' />

<BibList tag='script-newa' header='Bibliography' entrytype='non-online' />
