...
![Woleai script sample](../images/wole-sample.png)
<CaptionText text="The Woleaian syllabary as written by Egilimar in 1913. (Letters not identified.)"/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikipedia"
    sourceurl="https://en.wikipedia.org/wiki/File:Woleai_script.gif"
/>
...
<ArticlesList tag='script-wole' header='Related articles' />

<SourceLinksList tag='script-wole' header='External links' entrytype='online' />

<BibList tag='script-wole' header='Bibliography' entrytype='non-online' />
