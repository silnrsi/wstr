...
![Chakma script sample](../images/cakm-sample.png "Image provided by Tim Brookes.")
...
- [Full Unicode status for Chakma](/scrlang/unicode/cakm-unicode)



## Resources

<ArticlesList tag='script-cakm' header='Related articles' />

<SourceLinksList tag='script-cakm' header='External links' entrytype='online' />

<BibList tag='script-cakm' header='Bibliography' entrytype='non-online' />
