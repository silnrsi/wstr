...
scrpropsortname: Visible Speech
---
...
![Visible Speech script sample](../images/visp-sample.jpg)
<CaptionText text="Visible speech illustrations by Alexander Graham Bell."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:VisibleSpeech-illustrations.jpg"
/>
...
<SourceLinksList tag='script-visp' header='External links' entrytype='online' />
