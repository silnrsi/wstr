...
![Proto-Cuneiform script sample](../images/pcun-sample.jpg)
<CaptionText text="Clay tablet inscription from Jemdet Nasr period (around 3000 BC)"/>
<Attribution
    type="Image"
    copyholder="Zunkir"
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Proto-cuneiform_lexical_list_of_places_-_BM_116625.jpg"
/>
