...
![Sora Sompeng script sample](../images/sora-sample.jpg)
<CaptionText text="Mangei Gomango's statue in Odisha, India. He created the Sorang Sompeng script."/>
<Attribution
    type="Image"
    copyholder="Subhashish Panigrahi"
    copyurl=""
    copyyears="2014"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Mangei_Gomango.JPG"
/>
...
<ArticlesList tag='script-sora' header='Related articles' />

<SourceLinksList tag='script-sora' header='External links' entrytype='online' />

<BibList tag='script-sora' header='Bibliography' entrytype='non-online' />
