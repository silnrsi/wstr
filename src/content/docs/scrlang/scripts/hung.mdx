...
![Old Hungarian script sample](../images/hung-sample.jpg)
<CaptionText text="Old Hungarian Rovás inscription."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Enlaka_rovas_inscription.jpg"
/>
...
<ArticlesList tag='script-hung' header='Related articles' />

<SourceLinksList tag='script-hung' header='External links' entrytype='online' />

<BibList tag='script-hung' header='Bibliography' entrytype='non-online' />
