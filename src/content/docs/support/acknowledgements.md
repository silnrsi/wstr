...
- Some sample texts used by the [Language Font Finder][lfff] are from the [Google Fonts language data][googlefontstexts] and used under the terms of the [Apache 2.0 license][apache-2.0].
