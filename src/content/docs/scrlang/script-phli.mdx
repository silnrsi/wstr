...
Inscriptional Pahlavi employed nineteen symbols to represent sounds, plus script-phliific symbols to represent the numbers 1, 10, 20, 100 and 1000, which could be combined to write other numbers.
