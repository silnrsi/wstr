...
scrpropcode: x-balti-a
scrproptype: abugida
scrpropname: Balti-A
scrpropshortname: Balti-A script
...
<WsList script='x-balti-a' wsMax='5' />
...
- [Full Unicode status for Balti-A](/scrlang/unicode/x-balti-a-unicode)



## Resources

<ArticlesList tag='script-x-balti-a' header='Related articles' />

<SourceLinksList tag='script-x-balti-a' header='External links' entrytype='online' />

<BibList tag='script-x-balti-a' header='Bibliography' entrytype='non-online' />
