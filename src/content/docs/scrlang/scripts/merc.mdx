...
scrpropotcode: merc
scrpropsortname: Meroitic Cursive
---
...
![Meroitic Cursive script sample](../images/merc-sample.jpg)
<CaptionText text="Meroitic cursive writing."/>
<Attribution
    type="Image"
    copyholder="Piero d'Houin"
    copyurl=""
    copyyears="2010"
    ...
    author=""
    source="Wikipedia"
    sourceurl="https://fr.wikipedia.org/wiki/Fichier:%C3%89criture_m%C3%A9ro%C3%AFtique_cursive.jpg"
/>
...
<ArticlesList tag='script-merc' header='Related articles' />

<SourceLinksList tag='script-merc' header='External links' entrytype='online' />

<BibList tag='script-merc' header='Bibliography' entrytype='non-online' />
