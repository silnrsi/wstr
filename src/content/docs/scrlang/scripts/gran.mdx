...
![Grantha script sample](../images/gran-sample.png)
<CaptionText text="Excerpt from John 3:16 in the Grantha Script"/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:John_3_16_Sanskrit_translation_grantham_script.gif"
/>
...
<ArticlesList tag='script-gran' header='Related articles' />

<SourceLinksList tag='script-gran' header='External links' entrytype='online' />

<BibList tag='script-gran' header='Bibliography' entrytype='non-online' />
