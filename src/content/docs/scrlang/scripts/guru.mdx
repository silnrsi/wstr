...
![Gurmukhi sample](../images/guru-sample.png "From Wikipedia. See Use and History subject area.")
...
[comment]: # ( ![unknown image](../images/guru-GurkmukhiHalfForms2.png) )
...
[comment]: # ( ![unknown image](../images/guru-GurmukhiPakkhi.png) )
