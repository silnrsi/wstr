...
![Glagolitic script sample](../images/glag-sample.png)
<Attribution
    type="Image"
    copyholder="Curious Expeditions"
    copyurl=""
    copyyears="2007"
    ...
    author=""
    source="Flickr"
    sourceurl="https://www.flickr.com/photos/curiousexpeditions/1567410859/"
/>
...
<ArticlesList tag='script-glag' header='Related articles' />

<SourceLinksList tag='script-glag' header='External links' entrytype='online' />

<BibList tag='script-glag' header='Bibliography' entrytype='non-online' />
