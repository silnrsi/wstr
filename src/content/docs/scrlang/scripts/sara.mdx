...
![Sarati script sample](../images/nosample.png)
...
The Sarati script is not yet in Unicode. 
...
<SourceLinksList tag='script-sara' header='External links' entrytype='online' />
