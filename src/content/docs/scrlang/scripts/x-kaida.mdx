...
![Kaida script sample](../images/x-kaida-sample.jpg)
<CaptionText text="Kaidā glyphs (カイダー字, Kaidā ji) are a set of pictograms once used in the Yaeyama Islands of southwestern Japan."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Yonaguni_symbol.jpg"
/>
...
- [Full Unicode status for Kaida](/scrlang/unicode/x-kaida-unicode)



## Resources

<ArticlesList tag='script-x-kaida' header='Related articles' />

<SourceLinksList tag='script-x-kaida' header='External links' entrytype='online' />

<BibList tag='script-x-kaida' header='Bibliography' entrytype='non-online' />
