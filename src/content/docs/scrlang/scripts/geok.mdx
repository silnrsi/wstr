...
scrpropsortname: Khutsuri (Asomtavruli and Nuskuri)
---
...
![Khutsuri script sample](../images/geok-sample.png)
<CaptionText text="Texts from Ialguzidze's Ossetic religious books in Georgian Khutsuri alphabet."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:OSABC2highlited.jpg"
/>
...
<ArticlesList tag='script-geok' header='Related articles' />

<SourceLinksList tag='script-geok' header='External links' entrytype='online' />

<BibList tag='script-geok' header='Bibliography' entrytype='non-online' />