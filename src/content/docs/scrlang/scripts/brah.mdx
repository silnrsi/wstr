...
![Brahmi script sample](../images/brah-sample.png)
<CaptionText text="Brahmi inscription on Paderia Pillar."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    licenseurl=""
    author=""
    source="Epigraphia Indica Vol. V."
    sourceurl="https://commons.wikimedia.org/wiki/File:Paderia_Pillar.png"
/>
...
<ArticlesList tag='script-brah' header='Related articles' />

<SourceLinksList tag='script-brah' header='External links' entrytype='online' />

<BibList tag='script-brah' header='Bibliography' entrytype='non-online' />
