...
scrpropotcode: xsux
scrpropsortname: Cuneiform, Sumero-Akkadian
---
...
![Cuneiform script sample](../images/xsux-sample.png)
<CaptionText text="Cuneiform inscription from the Gate of all Nations in Persepolis"/>
<Attribution
    type="Image"
    copyholder="Nickmard Khoey"
    copyurl=""
    copyyears="2008"
    ...
    author=""
    source="Flickr"
    sourceurl="https://www.flickr.com/photos/nickmard/2591671132/in/set-72157605687516046/"
/>
...
- [Full Unicode status for Sumero-Akkadian Cuneiform](/scrlang/unicode/xsux-unicode)



## Resources

<ArticlesList tag='script-xsux' header='Related articles' />

<SourceLinksList tag='script-xsux' header='External links' entrytype='online' />

<BibList tag='script-xsux' header='Bibliography' entrytype='non-online' />
