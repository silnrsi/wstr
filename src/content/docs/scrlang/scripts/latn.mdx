...
In The Unicode Standard, Latin script implementation is discussed in {link:http://www.unicode.org/versions/latest/ch07.pdf Chapter 7 Europe-I: Modern and Liturgical Scripts}.

- [Full Unicode status for Latin](/scrlang/unicode/latn-unicode.md)

Other:

- [Unicode status for Modifier letters](/scrlang/unicode/x-mod-letters-unicode.md)
