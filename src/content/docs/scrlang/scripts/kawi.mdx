...
![Kawi script sample](../images/kawi-sample.png)
<CaptionText text="Laguna Copperplate Inscription in the Kawi script "/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikipedia"
    sourceurl="https://en.wikipedia.org/wiki/File:Laguna_Copperplate_Inscription.gif"
/>
...
<ArticlesList tag='script-kawi' header='Related articles' />

<SourceLinksList tag='script-kawi' header='External links' entrytype='online' />

<BibList tag='script-kawi' header='Bibliography' entrytype='non-online' />
