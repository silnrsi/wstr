...
![Tirhuta script sample](../images/tirh-sample.png "Yogendra Yadava, 'Open Learning Program', 2010.")
...
<ArticlesList tag='script-tirh' header='Related articles' />

<SourceLinksList tag='script-tirh' header='External links' entrytype='online' />

<BibList tag='script-tirh' header='Bibliography' entrytype='non-online' />
