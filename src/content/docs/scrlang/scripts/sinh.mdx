...
![Sinhala sample](../images/sinh-sample.jpg "Detail from photo of a wall with posters in Sinhala script in Sri Lanka")
...
[comment]: # ( ![unknown image](../images/sinh-SinhaV.png) )
...
[comment]: # ( ![unknown image](../images/sinh-SinhalaHal.png.jpg) )
