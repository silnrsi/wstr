...
3. Add the special element (in this case, **Badge**) to your page whereever you would like it.
...
See [Starlight docs - Badges][starlight-badges] for details. Here are some examples:
...
See [Starlight docs - Steps][starlight-steps]. for details. Here is the **Steps** element that produced the steps at the beginning of this section:
