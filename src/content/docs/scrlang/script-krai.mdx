...
<details>
<summary>Read the full description...'</summary>Bantawa is spoken in Sikkim and Nepal by almost 400,000 people. The script appears to be a modification of [Khambu Rai](/scrlang/script-krai), which is used for writing the same language.
