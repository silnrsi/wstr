...
Telugu writing employs a script-teluific set of digits from 0-9. In the past, these were combined with eight arithmetic symbols for writing fractions. The system for writing fractions was complex, for example, 3/8 was written using four symbols representing 1, 1/4, 2 and 1/16 (i.e. 1 x 1/4 + 2 x 1/16). In modern texts, however, decimal fractions are used.
</details>
