...
scrpropisonumkey: 124 (right-to-left alphabetic)
scrpropotcode: armi
scrpropsortname: Imperial Aramaic
---
...
![Imperial Aramaic script sample](../images/armi-sample.jpg)
<CaptionText text="Detail from incantation bowl with Aramaic inscription"/>
<Attribution
    type="Image"
    copyholder="Osama Shukir Muhammed Amin"
    copyurl=""
    copyyears="2019"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Incantation_bowl,_from_Babylon,_Iraq._Aramaic_inscription_with_a_human_figure,_4th_to_7th_century_CE._Pergamon_Museum,_Berlin.jpg"
/>
...
- [Full Unicode status for Imperial Aramaic](/scrlang/unicode/armi-unicode)



## Resources

<ArticlesList tag='script-armi' header='Related articles' />

<SourceLinksList tag='script-armi' header='External links' entrytype='online' />

<BibList tag='script-armi' header='Bibliography' entrytype='non-online' />
