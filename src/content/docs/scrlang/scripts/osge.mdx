...
![Osage script sample](../images/osge-sample.jpg)
<CaptionText text="Osage consonants"/>
<Attribution
    type="Image"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Osage_consonants.png"
/>
...
<SourceLinksList tag='script-osge' header='External links' entrytype='online' />

<BibList tag='script-osge' header='Bibliography' entrytype='non-online' />
