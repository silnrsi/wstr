...
scrpropisonumkey: 933 (private use, alias, or special)
scrpropotcode: unspecified
scrpropsortname: Bagan (Eghap)
---
...
<details>
<summary>Read the full description...</summary>The script bears some similarity to the Bamum script, used in a neighbouring region, which has led to speculation that the two scripts developed concurrently from a common source, but did not borrow directly from each other. It was created by the Eghap King Pufong in the late C19th or early C20th, and used for private correspondence and record-keeping, although it is not believed to have ever enjoyed widespread use.
...
- [Full Unicode status for Bagam](/scrlang/unicode/x-bagam-unicode)



## Resources

<ArticlesList tag='script-x-bagam' header='Related articles' />

<SourceLinksList tag='script-x-bagam' header='External links' entrytype='online' />

<BibList tag='script-x-bagam' header='Bibliography' entrytype='non-online' />
