...
![Bhaiksuki script sample](../images/bhks-sample.png)
<CaptionText text="&quot;Bhaiksuki&quot; in Bhaiksuki script"/>
<Attribution
    type="Image"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Shukla_Bhaiksuki.svg"
/>
...
<ArticlesList tag='script-bhks' header='Related articles' />

<SourceLinksList tag='script-bhks' header='External links' entrytype='online' />

<BibList tag='script-bhks' header='Bibliography' entrytype='non-online' />
