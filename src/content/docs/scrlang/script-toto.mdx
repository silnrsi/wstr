...
scrpropisocode: 294 (left-to-right alphabetic)
...
There are currently no script-totoific digits. A column including 10 free slots may be needed in the future if the community decides to encode script-totoific digits.
