...
scrpropotcode: mymr, mym2
scrpropsortname: Myanmar (Burmese)
---
...
![Myanmar script sample](../images/mymr-sample.png "From the Universal Declaration of Human Rights in Myanmar.")
...
:::note
Languages listed as _unwritten_ would likely use Myanmar script if a writing system were developed. A status of _obsolete_ indicates that the writing system is no longer in use for that language; the language may still be spoken.
:::
...
- [Full Unicode status for Myanmar](/scrlang/unicode/mymr-unicode)
...
<ArticlesList tag='script-mymr' header='Related articles' />

<SourceLinksList tag='script-mymr' header='External links' entrytype='online' />

<BibList tag='script-mymr' header='Bibliography' entrytype='non-online' />
