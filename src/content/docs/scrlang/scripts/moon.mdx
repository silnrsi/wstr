...
![Moon (Moon code, Moon script, Moon type "Detail from Moon-type-chart (see Use & History)") sample](../images/moon-sample.jpg "Detail from Moon-type-chart (see Use & History)")
