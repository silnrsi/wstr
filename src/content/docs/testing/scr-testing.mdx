...
## Script properties (using Details)
...
The Tai Viet script is used for writing the Tai Dam, Tai Dón, Tai Daeng, Thai Song and Tày Tac languages originating in Vietnam, Laos, China and Thailand.
<details>
<summary>Read the full extended description...</summary>
