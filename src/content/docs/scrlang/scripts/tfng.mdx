...
scrpropotcode: tfng
scrpropsortname: Tifinagh (Berber)
---
...
![Tifinagh script sample](../images/tfng-sample.png "Tifinagh carving, used with permission of Tim Brookes.")
...
<ArticlesList tag='script-tfng' header='Related articles' />

<SourceLinksList tag='script-tfng' header='External links' entrytype='online' />

<BibList tag='script-tfng' header='Bibliography' entrytype='non-online' />
