...
![Sundanese script sample](../images/sund-sample.png)
<CaptionText text="Excerpt from a Sundanese vocabulary list."/>
<Attribution
    type="Image"
...
<ArticlesList tag='script-sund' header='Related articles' />

<SourceLinksList tag='script-sund' header='External links' entrytype='online' />

<BibList tag='script-sund' header='Bibliography' entrytype='non-online' />
