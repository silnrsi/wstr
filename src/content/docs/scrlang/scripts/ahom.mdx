...
![Ahom script sample](../images/ahom-sample.png "Stephen Morey, 'Bar Amra Ahom Manuscript', 2007.")
...
- [Full Unicode status for Ahom](/scrlang/unicode/ahom-unicode)



## Resources

<ArticlesList tag='script-ahom' header='Related articles' />

<SourceLinksList tag='script-ahom' header='External links' entrytype='online' />

<BibList tag='script-ahom' header='Bibliography' entrytype='non-online' />
