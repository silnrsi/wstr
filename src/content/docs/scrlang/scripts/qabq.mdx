...
![Badaga script sample](../images/qabq-sample.jpg "Detail from booklet used to learn the Badaga script")
...
- [Full Unicode status for Badaga](/scrlang/unicode/qabq-unicode)



## Resources

<ArticlesList tag='script-qabq' header='Related articles' />

<SourceLinksList tag='script-qabq' header='External links' entrytype='online' />

<BibList tag='script-qabq' header='Bibliography' entrytype='non-online' />
