...
![Phoenician script sample](../images/phnx-sample.png)
<Attribution
    type="Image"
    copyholder="Özgür Mülazımoğlu"
    copyurl=""
    copyyears="2009"
    ...
    author=""
    source="Flickr"
    sourceurl="https://www.flickr.com/photos/mulazimoglu/3323335392/"
/>
...
:::note
Languages listed as _unwritten_ would likely use Phoenician script if a writing system were developed. 
:::
...
- [Full Unicode status for Phoenician](/scrlang/unicode/phnx-unicode)



## Resources

<ArticlesList tag='script-phnx' header='Related articles' />

<SourceLinksList tag='script-phnx' header='External links' entrytype='online' />

<BibList tag='script-phnx' header='Bibliography' entrytype='non-online' />
