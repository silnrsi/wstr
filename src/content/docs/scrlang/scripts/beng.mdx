...
![Bengali script sample](../images/beng-sample.png "From the Universal Declaration of Human Rights in Bengali.")
...
<ArticlesList tag='script-beng' header='Related articles' />

<SourceLinksList tag='script-beng' header='External links' entrytype='online' />

<BibList tag='script-beng' header='Bibliography' entrytype='non-online' />
