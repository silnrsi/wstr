...
![New Tai Lue script sample](../images/talu-sample.png)
<Attribution
    type="Image"
    copyholder="SIL Global"
    copyurl=""
    copyyears="2012"
    ...
    author=""
    source="SIL"
    sourceurl="https://software.sil.org/daibanna/"
/>
...
The New Tai Lue script (also known as Xishuangbanna Dai) is an abugida derived from Old Tai Lue, which is derived from the [Lanna](/scrlang/scripts/lana) script.It was created in the 1950s and is used mainly by the Tai Lue (also called Water Dai) people in Southern China for writing the Lü (also called Tai Lue) language. The language is also spoken in Burma, Laos, Thailand and Vietnam where it is written with the Old Tai Lue script.
...
- [Full Unicode status for New Tai Lue](/scrlang/unicode/talu-unicode)



## Resources

<ArticlesList tag='script-talu' header='Related articles' />

<SourceLinksList tag='script-talu' header='External links' entrytype='online' />

<BibList tag='script-talu' header='Bibliography' entrytype='non-online' />
