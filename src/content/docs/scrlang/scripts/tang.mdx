...
![Tangut script sample](../images/nosample.png)
...
<SourceLinksList tag='script-tang' header='External links' entrytype='online' />

<BibList tag='script-tang' header='Bibliography' entrytype='non-online' />
