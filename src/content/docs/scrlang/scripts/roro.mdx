...
![Rongorongo script sample](../images/roro-sample.jpg)
<CaptionText text="Front side of the rongorongo Tablet E (Keiti), likely from Tahiti c. 1880"/>
<Attribution
    type="Image"
    copyholder="Kwamikagami"
    copyurl=""
    copyyears="2008"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Rongorongo_E-r_Keiti.jpg"
/>
...
<ArticlesList tag='script-roro' header='Related articles' />

<SourceLinksList tag='script-roro' header='External links' entrytype='online' />

<BibList tag='script-roro' header='Bibliography' entrytype='non-online' />
