...
![Kaddare script sample](../images/qa75-sample.jpg "Kaddare sample")
...
<ArticlesList tag='script-qa75' header='Related articles' />

<SourceLinksList tag='script-qa75' header='External links' entrytype='online' />

<BibList tag='script-qa75' header='Bibliography' entrytype='non-online' />
