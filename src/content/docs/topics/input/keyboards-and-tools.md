...
[Keymagic][keymagic] is an open source keyboarding system which works on Windows, macOS, and Ubuntu. Whilst similar to KMFL, it uses its own source format rather than Keyman .kmn files. 
