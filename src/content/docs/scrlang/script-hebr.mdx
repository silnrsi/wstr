...
Punctuation in the Hebrew script is much the same as in the Latin script, with the exception of a script-hebrific hyphen _maqaf_, colon _sof pasuq_, forward/vertical slash _paseq_, abbreviation mark _geresh_, and a mark _gershayim_ to indicate that a word is an acronym.
