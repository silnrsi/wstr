...
|||
|---|---|
|2026-05-11| Downloaded and extracted the `styles` sample text from commit [`5835bfb`][commit5835bfb], before converting to a JSON file. |

[commit5835bfb]: https://github.com/google/fonts/commit/5835bfbb8a4ce400eb9ec6e7b7a6b34053f83854
