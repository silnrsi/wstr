...
scrpropisonumkey: 264 (left-to-right alphabetic)
scrpropotcode: mroo
scrpropsortname: Mro, Mru
---
...
![Mro script sample](../images/mroo-sample.png "Image provided by Tim Brookes.")
...
- [Full Unicode status for Mro](/scrlang/unicode/mroo-unicode)



## Resources

<ArticlesList tag='script-mroo' header='Related articles' />

<SourceLinksList tag='script-mroo' header='External links' entrytype='online' />

<BibList tag='script-mroo' header='Bibliography' entrytype='non-online' />
