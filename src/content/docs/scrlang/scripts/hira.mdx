...
![Hiragana script sample](../images/hira-sample.jpg)
<CaptionText text="Station sign, Kitahama, Hokkaido"/>
<Attribution
    type="Image"
    copyholder="shirokazan"
    copyurl=""
    copyyears="2008"
    license="CC BY 2.0"
    ...
    author=""
    source="Flickr"
    sourceurl="https://www.flickr.com/photos/11302107@N05/3009177612"
/>
...
<ArticlesList tag='script-hira' header='Related articles' />

<SourceLinksList tag='script-hira' header='External links' entrytype='online' />

<BibList tag='script-hira' header='Bibliography' entrytype='non-online' />
