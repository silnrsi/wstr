...
scrpropisonumkey: 352 (alphasyllabic)
scrpropotcode: thai
scrpropsortname: Thai
---
...
![Thai script sample](../images/thai-sample.png "madaboutasia via Flickr, 2005.")
...
Please note that, although orthographically the Thai script does exhibit reordering behaviour, that reordering is not typically reflected in software implementations. See [Reordering and Data Storage Order](/articlelib/r/reordering-and-data-storage-order) for more details of this.
</details>
...
- [Full Unicode status for Thai](/scrlang/unicode/thai-unicode)
...
<ArticlesList tag='script-thai' header='Related articles' />

<SourceLinksList tag='script-thai' header='External links' entrytype='online' />

<BibList tag='script-thai' header='Bibliography' entrytype='non-online' />
