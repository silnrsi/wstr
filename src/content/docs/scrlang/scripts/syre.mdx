...
scrpropsortname: Syriac (Estrangelo variant)
---
...
![Syriac script, Estrangelo variant sample](../images/syre-sample.png)
...
<ArticlesList tag='script-syre' header='Related articles' />

<SourceLinksList tag='script-syre' header='External links' entrytype='online' />

<BibList tag='script-syre' header='Bibliography' entrytype='non-online' />
