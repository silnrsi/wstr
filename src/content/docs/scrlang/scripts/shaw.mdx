...
![Shavian script sample](../images/shaw-sample.png "Excerpt from from Kingsley Read's &quot;Suggestions for Writing&quot;.")
...
<ArticlesList tag='script-shaw' header='Related articles' />

<SourceLinksList tag='script-shaw' header='External links' entrytype='online' />

<BibList tag='script-shaw' header='Bibliography' entrytype='non-online' />
