...
<span style='color: red'>_Missing image: Ethioforms.png_</span>
...
<span style='color: red'>_Missing image: EthioH.png_</span>
...
:::note
Languages listed as _unwritten_ would likely use Ethiopic script if a writing system were developed. An _obsolete_ value indicates that the writing system is no longer in use for that language; the language may still be spoken.
:::
...
[Full Unicode status information](/scrlang/unicode/ethi-unicode)
