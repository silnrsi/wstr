...
![Old Persian script sample](../images/xpeo-sample.jpg)
<CaptionText text="Old Persian Cuneiform inscription at Persepolis, Iran."/>
<Attribution
    type="Image"
    copyholder="Ginolerhino"
    copyurl=""
    copyyears="2002"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Pers%C3%A9polis._Inscription.jpg"
/>
...
<ArticlesList tag='script-xpeo' header='Related articles' />

<SourceLinksList tag='script-xpeo' header='External links' entrytype='online' />

<BibList tag='script-xpeo' header='Bibliography' entrytype='non-online' />
