...
scrpropshortname: Cherokee script
...
scrpropisonumkey: 445 (syllabic)
scrpropotcode: cher
scrpropsortname: Cherokee
---
...
![Cherokee script sample](../images/cher-sample.png)
<CaptionText text="Public notice from 1828"/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Bilingual_notice_in_English_and_Cherokee_1828.jpg"
/>
...
- [Full Unicode status for Cherokee](/scrlang/unicode/cher-unicode)



## Resources

<ArticlesList tag='script-cher' header='Related articles' />

<SourceLinksList tag='script-cher' header='External links' entrytype='online' />

<BibList tag='script-cher' header='Bibliography' entrytype='non-online' />
