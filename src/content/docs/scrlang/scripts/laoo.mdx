...
![Lao script sample](../images/laoo-sample.png)
<CaptionText text="Book from Progress Printing in Moscow, 1979."/>
<Attribution
    type="Image"
    copyholder="aysomphone"
    copyurl=""
    copyyears="2007"
    ...
    author=""
    source="Flickr"
    sourceurl="https://www.flickr.com/photos/9194595@N07/1511570444/in/set-72157602308374392/"
/>
...
Please note that, although orthographically the Lao script does exhibit reordering behaviour, that reordering is not typically reflected in software implementations. See [Reordering and Data Storage Order](/articlelib/r/reordering-and-data-storage-order) for more details of this.
...
<ArticlesList tag='script-laoo' header='Related articles' />

<SourceLinksList tag='script-laoo' header='External links' entrytype='online' />

<BibList tag='script-laoo' header='Bibliography' entrytype='non-online' />
