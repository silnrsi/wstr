...
scrpropisonumkey: 450 (syllabic)
scrpropotcode: hmng
scrpropsortname: Pahwah Hmong
---
...
![Pahawh Hmong script sample](../images/hmng-sample.png "Image provided by Tim Brookes.")
...
<details>
<summary>Read the full description...</summary>It was created by Shong Lue, who claimed to have been sent by God to teach the script to the Hmong people, following a series of divine revelations. He developed the script in four stages, the second and third of which are the forms in most widespread current use.
...
:::note
Languages listed as _unwritten_ would likely use Pahawh Hmong script if a writing system were developed. A status of _obsolete_ indicates that the writing system is no longer in use for that language; the language may still be spoken.
:::
...
- [Full Unicode status for Pahawh Hmong](/scrlang/unicode/hmng-unicode)



## Resources

<ArticlesList tag='script-hmng' header='Related articles' />

<SourceLinksList tag='script-hmng' header='External links' entrytype='online' />

<BibList tag='script-hmng' header='Bibliography' entrytype='non-online' />
