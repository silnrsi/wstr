...
For internal links use only explicit paths from the `src/content/docs` base directory without the `.md` extension. Do not use relative paths like `./filename` or `../filename`. 
