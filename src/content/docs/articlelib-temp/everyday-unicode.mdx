...
In answer to the question "What Is Unicode?", the [Unicode website says](http://www.unicode.org/standard/WhatIsUnicode.html): 
...
ScriptSource provides a lot of Unicode information and presents it in a helpful way. I talk about that here: [Unicode information on ScriptSource](https://scriptsource.org/entry/z3hs8db5ct).
