...
![Latin script sample](../images/nosample.png)
...
<details>
<summary>Read the full description...</summary>It is also the script used for writing a number of Romance, Germanic, Baltic and non-Indo-European languages, as well as the [International Phonetic Alphabet (IPA)](/articlelib/t/the-international-phonetic-alphabet-and-latin-script).
...
Data indicating how characters are used to represent sounds is available for the following languages as written with Latin script:

- [Adawama Fulfulde](/scrlang/graphemes/fub-latn) (also available for [Arabic script](/scrlang/graphemes/fub-arab))
- [Asturian](/scrlang/graphemes/ast-latn)
- [Bacama](/scrlang/graphemes/bcy-latn)
- [Ca̱hungwa̱rya̱](/scrlang/graphemes/nat-latn)
- [English](/scrlang/graphemes/en-latn)
- [German](/scrlang/graphemes/de-latn)
- [Hausa](/scrlang/graphemes/ha-latn)
- [Iceve-Maci](/scrlang/graphemes/bec-latn)
- [Indonesian](/scrlang/graphemes/id-latn)
- [Mattokki](/scrlang/graphemes/xnz-latn)  (also available for [Coptic script](/scrlang/graphemes/xnz-copt))
- [Pangu](/scrlang/graphemes/png-latn)
- [Serer-Sine](scrlang/graphemes/srr-latn)
- [Spanish](/scrlang/graphemes/es-latn)
- [Sudanese Arabic](/scrlang/graphemes/apd-latn) (also available for [Arabic script](/scrlang/graphemes/apd-arab))
- [Tolaki](/scrlang/graphemes/lbw-latn)
- [Wolof](/scrlang/graphemes/wo-latn) (also available for [Arabic script](/scrlang/graphemes/wo-arab))
- [Yala](/scrlang/graphemes/yba-latn)
- [Yi](/scrlang/graphemes/ii-latn) (also available for [Yi script](/scrlang/graphemes/ii-yiii))

<SourceLinksList tag='script-latn' header='External links' entrytype='online' />

<BibList tag='script-latn' header='Bibliography' entrytype='non-online' />
