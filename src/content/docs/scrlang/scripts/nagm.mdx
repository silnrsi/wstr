...
![Nag Mundari script sample](../images/nagm-sample.png)
<CaptionText text="Mundari Bani script sample."/>
<Attribution
    type="Image"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Shukla_Mundari.svg"
/>
...
<SourceLinksList tag='script-nagm' header='External links' entrytype='online' />
