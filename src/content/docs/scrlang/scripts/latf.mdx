...
scrpropsortname: Latin (Fraktur variant)
---
...
![Latin script, Fraktur variant sample](../images/latf-sample.png)
<CaptionText text="Letters and numerals in Fraktur script."/>
<Attribution
    type="Image"
    copyholder="Djmutex"
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Fraktur_walbaum.png"
/>
...
- [Full Unicode status for Fraktur](/scrlang/unicode/latf-unicode)



## Resources

<ArticlesList tag='script-latf' header='Related articles' />

<SourceLinksList tag='script-latf' header='External links' entrytype='online' />

<BibList tag='script-latf' header='Bibliography' entrytype='non-online' />
