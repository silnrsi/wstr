...
![Gujarati script sample](../images/gujr-sample.png)
<Attribution
    type="Image"
    copyholder="BernardM"
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Gandhi%27s_hut-karadi.jpg"
/>
...
- [Full Unicode status for Gujarati](/scrlang/unicode/gujr-unicode)
...
<ArticlesList tag='script-gujr' header='Related articles' />

<SourceLinksList tag='script-gujr' header='External links' entrytype='online' />

<BibList tag='script-gujr' header='Bibliography' entrytype='non-online' />
