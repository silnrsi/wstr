...
![Tani script sample](../images/x-tani-sample.png "Tani Lipi sample")
...
- [Full Unicode status for Tani](/scrlang/unicode/x-tani-unicode)



## Resources

<ArticlesList tag='script-x-tani' header='Related articles' />

<SourceLinksList tag='script-x-tani' header='External links' entrytype='online' />

<BibList tag='script-x-tani' header='Bibliography' entrytype='non-online' />
