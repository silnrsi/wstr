...
![New Tai Lue sample](../images/talu-sample.png "New Tai Lue script sample using the SIL Dai Banna font")
...
[comment]: # ( ![unknown image](../images/talu-NTLvowels.png) )
...
[comment]: # ( ![unknown image](../images/talu-NTLtone.png) )
