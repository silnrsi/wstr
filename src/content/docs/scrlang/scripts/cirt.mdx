...
![Cirth script sample](../images/cirt-sample.png "Balin's tomb upper inscription, set using the Angerthas font for Cirth runes.")
...
<SourcesList tag='script-cirt' header='External links' />

<Bibliography tag='script-cirt' header='Bibliography' />
