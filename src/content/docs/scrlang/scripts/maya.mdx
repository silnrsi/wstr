...
scrpropsortname: Mayan hieroglyphs
---
...
![Mayan hieroglyphs script sample](../images/maya-sample.png "James Gaither, Flickr, 2008. .")
...
:::note
Languages listed as _unwritten_ would likely use Mayan hieroglyphs script if a writing system were developed. 
:::
...
- [Full Unicode status for Mayan hieroglyphs](/scrlang/unicode/maya-unicode)



## Resources

<ArticlesList tag='script-maya' header='Related articles' />

<SourceLinksList tag='script-maya' header='External links' entrytype='online' />

<BibList tag='script-maya' header='Bibliography' entrytype='non-online' />
