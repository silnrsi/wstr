...
![Syloti Nagri script sample](../images/sylo-sample.jpg)
<CaptionText text=" Photo of a page from a Sylheti Nagri book written in the 1800s."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikipedia"
    sourceurl="https://en.wikipedia.org/wiki/File:Halot-un-nabi-page1.gif"
/>
...
<SourceLinksList tag='script-sylo' header='External links' entrytype='online' />

<BibList tag='script-sylo' header='Bibliography' entrytype='non-online' />
