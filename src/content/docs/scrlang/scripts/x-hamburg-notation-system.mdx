...
scrpropcode: x-hamburg-notation-system
...
scrpropsortname: HamNoSys Notation
---
...
![HamNoSys Notation sample](../images/x-hamburg-notation-system-sample.png "Detail from 'Goldilocks and the Three Bears' in HamNoSys")
...
<WsList script='x-hamburg-notation-system' wsMax='5' />
...
- [Full Unicode status for HamNoSys](/scrlang/unicode/x-hamburg-notation-system-unicode)



## Resources

<ArticlesList tag='script-x-hamburg-notation-system' header='Related articles' />

<SourceLinksList tag='script-x-hamburg-notation-system' header='External links' entrytype='online' />

<BibList tag='script-x-hamburg-notation-system' header='Bibliography' entrytype='non-online' />
