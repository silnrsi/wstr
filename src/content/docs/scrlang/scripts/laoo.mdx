...
:::note
Languages listed as _unwritten_ would likely use Lao script if a writing system were developed. An _obsolete_ value indicates that the writing system is no longer in use for that language; the language may still be spoken.
:::
