...
![Cham sample](../images/cham-sample.png "From Wikipedia. See Use and History subject area.")
...
[comment]: # ( ![unknown image](../images/cham-ChamGa.png) )
...
[comment]: # ( ![unknown image](../images/cham-ChamGlide.png) )
