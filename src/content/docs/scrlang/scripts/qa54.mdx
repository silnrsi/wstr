...
![Mwangwego script sample](../images/qa54-sample.png)
...
<ArticlesList tag='script-qa54' header='Related articles' />

<SourceLinksList tag='script-qa54' header='External links' entrytype='online' />

<BibList tag='script-qa54' header='Bibliography' entrytype='non-online' />
