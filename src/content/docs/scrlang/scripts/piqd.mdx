...
scrpropsortname: Klingon (KLI PIqaD)
---
...
The PIqaD (Klingon) script is not yet in Unicode.
...
<ArticlesList tag='script-piqd' header='Related articles' />

<SourceLinksList tag='script-piqd' header='External links' entrytype='online' />

<BibList tag='script-piqd' header='Bibliography' entrytype='non-online' />
