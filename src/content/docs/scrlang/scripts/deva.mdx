...
scrpropsortname: Devanagari (Nagari)
---
...
![Devanagari script sample](../images/deva-sample.png "From the Universal Declaration of Human Rights in Magahi.")
...
<ArticlesList tag='script-deva' header='Related articles' />

### Grapheme and phoneme data

Data indicating how characters are used to represent sounds is available for the following languages as written with Devanagari script:

- [Nepali](/scrlang/graphemes/ne-deva)

<SourceLinksList tag='script-deva' header='External links' entrytype='online' />

<BibList tag='script-deva' header='Bibliography' entrytype='non-online' />
