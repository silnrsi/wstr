...
scrpropsortname: SignFont Notation
---
...
<WsList script='x-signfont' wsMax='5' />
...
- [Full Unicode status for SignFont Notation](/scrlang/unicode/x-signfont-unicode)



## Resources

<ArticlesList tag='script-x-signfont' header='Related articles' />

<SourceLinksList tag='script-x-signfont' header='External links' entrytype='online' />

<BibList tag='script-x-signfont' header='Bibliography' entrytype='non-online' />
