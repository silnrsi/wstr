...
<ArticlesList tag='script-copt' header='Related articles' />

### Grapheme and phoneme data

Data indicating how characters are used to represent sounds is available for the following languages as written with Coptic script:

- [Mattokki](/scrlang/graphemes/xnz-copt) (also available for [Latin script](/scrlang/graphemes/xnz-latn))

<SourceLinksList tag='script-copt' header='External links' entrytype='online' />

<BibList tag='script-copt' header='Bibliography' entrytype='non-online' />
