...
For instance, to access the literacy feature in Charis SIL, append ":litr=1" to the name of the font in the control so that the font name reads: Charis SIL:litr=1. 
