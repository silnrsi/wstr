...
![Limbu script sample](../images/limb-sample.png "Steve Smith and Isai Limbu Literature Association Nepal, 'Introduction to the gospel of Mark', 2009.")
...
<ArticlesList tag='script-limb' header='Related articles' />

<SourceLinksList tag='script-limb' header='External links' entrytype='online' />

<BibList tag='script-limb' header='Bibliography' entrytype='non-online' />
