...
![Figure: LibreOffice](images/5524-libreoffice.png "Most features in one dialog")
...
![Figure: PTXprint](images/5524-ptxprint-tooltips-sample.png "PTXprint tooltip with sample alternates")
