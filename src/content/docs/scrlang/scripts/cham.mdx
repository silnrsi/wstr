...
![Cham script sample](../images/cham-sample.png)
<CaptionText text="Excerpt of inscription from Po Nagar temple, Vietnam. "/>
<Attribution
    type="Image"
    copyholder="Gryffindor"
    copyurl=""
    copyyears="2009"
    license="CC BY 3.0"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:National_Museum_of_Vietnamese_History42.JPG"
/>
...
<ArticlesList tag='script-cham' header='Related articles' />

<SourceLinksList tag='script-cham' header='External links' entrytype='online' />
