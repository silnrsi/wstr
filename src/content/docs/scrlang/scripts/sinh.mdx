...
![Sinhala script sample](../images/sinh-sample.jpg)
<CaptionText text="Posters in Sinhala script in Sri Lanka"/>
<Attribution
    type="Image"
    copyholder="Jasy"
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Sinhala_script_posters_on_wall.jpg"
/>
...
<ArticlesList tag='script-sinh' header='Related articles' />

<SourceLinksList tag='script-sinh' header='External links' entrytype='online' />

<BibList tag='script-sinh' header='Bibliography' entrytype='non-online' />
