...
![Balinese script sample](../images/bali-sample.png)
<CaptionText text="Street sign in the Buleleng regency of Bali, Indonesia."/>
<Attribution
    type="Image"
    copyholder="っ"
    copyurl=""
    ...
    author=""
    source="Wikipedia"
    sourceurl="https://en.wikipedia.org/wiki/File:JL_DIPONEGORO_200507.jpg"
/>
...
<ArticlesList tag='script-bali' header='Related articles' />

<SourceLinksList tag='script-bali' header='External links' entrytype='online' />

<BibList tag='script-bali' header='Bibliography' entrytype='non-online' />
