...
![Micmac Hieroglyphs script sample](../images/qabg-sample.png "Christian Kauder, 1866.")
...
- [Full Unicode status for Micmac hieroglyphs](/scrlang/unicode/qabg-unicode)



## Resources

<ArticlesList tag='script-qabg' header='Related articles' />

<SourceLinksList tag='script-qabg' header='External links' entrytype='online' />

<BibList tag='script-qabg' header='Bibliography' entrytype='non-online' />
