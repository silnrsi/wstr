...
![Nandinagari script sample](../images/nand-sample.jpg)
<CaptionText text="A palm leaf manuscript in Nandinagari script."/>
<Attribution
    type="Image"
    copyholder="ಶ್ರೀ"
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Nandinagari_Manuscript.jpg"
/>
...
<ArticlesList tag='script-nand' header='Related articles' />

<SourceLinksList tag='script-nand' header='External links' entrytype='online' />

<BibList tag='script-nand' header='Bibliography' entrytype='non-online' />
