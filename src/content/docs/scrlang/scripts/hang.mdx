...
In The Unicode Standard, Hangul implementation is discussed in {link:http://www.unicode.org/versions/latest/ch18.pdf Chapter 18 East Asia}.

- [Full Unicode status for Hangul](/scrlang/unicode/hang-unicode.md)
