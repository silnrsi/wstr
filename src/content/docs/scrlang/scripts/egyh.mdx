...
scrpropsortname: Egyptian hieratic
---
...
![Egyptian hieratic script sample](../images/egyh-sample.png)
<CaptionText text="The Edwin Smith Papyrus, the world's oldest surviving surgical document."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Edwin_Smith_Papyrus_v2.jpg"
/>
...
- [Full Unicode status for Egyptian Hieratic](/scrlang/unicode/egyh-unicode)



## Resources

<ArticlesList tag='script-egyh' header='Related articles' />

<SourceLinksList tag='script-egyh' header='External links' entrytype='online' />

<BibList tag='script-egyh' header='Bibliography' entrytype='non-online' />
