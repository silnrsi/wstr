...
import TaggedArticles from '../../../../components/TaggedArticles.astro';
...
<TaggedArticles tag='script-arab' />

<TaggedSources tag='script-arab' section='external' />

<TaggedSources tag='script-arab' section='bibliography' />