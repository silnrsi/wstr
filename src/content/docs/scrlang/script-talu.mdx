...
The New Tai Lue script (also known as Xishuangbanna Dai) is an alphabet derived from Old Tai Lue, which is derived from the [Lanna](/scrlang/script-talu) script.
...
Digits from one to nine are written with script-taluific symbols.
