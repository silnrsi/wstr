...
The Korean language is often written using a combination of a language-specific script, called Hangul, and Chinese Han characters, called hanja in Korean.
