...
![Javanese script sample](../images/java-sample.png)
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Javanese_script01.jpg"
/>
...
<ArticlesList tag='script-java' header='Related articles' />

<SourceLinksList tag='script-java' header='External links' entrytype='online' />

<BibList tag='script-java' header='Bibliography' entrytype='non-online' />
