...
<details>
<summary>Read the full description...'</summary>The language has variously been written in the [Balti](/scrlang/script-qa63) (sometimes called Balti-A to distinguish it from Balti-B), [Tibetan](/scrlang/script-Tibt), [Arabic](/scrlang/script-Arab) and [Devanagari](/scrlang/script-Deva) scripts, reflecting the multi-ethnic makeup and eventful political history of the region.
