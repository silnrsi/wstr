...
scrpropcode: x-hausa-raina-kama
...
scrpropsortname: Raina Kama (Hausa)
---
...
<WsList script='x-hausa-raina-kama' wsMax='5' />
...
- [Full Unicode status for Raina Kama](/scrlang/unicode/x-hausa-raina-kama-unicode)



## Resources

<ArticlesList tag='script-x-hausa-raina-kama' header='Related articles' />

<SourceLinksList tag='script-x-hausa-raina-kama' header='External links' entrytype='online' />

<BibList tag='script-x-hausa-raina-kama' header='Bibliography' entrytype='non-online' />
