...
![Lydian script sample](../images/lydi-sample.jpg)
<CaptionText text="Marble stele with a Lydian inscription."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Lydian_Text.jpg"
/>
...
<SourceLinksList tag='script-lydi' header='External links' entrytype='online' />

<BibList tag='script-lydi' header='Bibliography' entrytype='non-online' />
