...
scrpropsortname: Han (Traditional variant)
---
...
<ArticlesList tag='script-hant' header='Related articles' />

<SourceLinksList tag='script-hant' header='External links' entrytype='online' />

<BibList tag='script-hant' header='Bibliography' entrytype='non-online' />
