...
![Bamum script sample](../images/bamu-sample.png "Image used here with permission.")
...
<ArticlesList tag='script-bamu' header='Related articles' />

<SourceLinksList tag='script-bamu' header='External links' entrytype='online' />

<BibList tag='script-bamu' header='Bibliography' entrytype='non-online' />
