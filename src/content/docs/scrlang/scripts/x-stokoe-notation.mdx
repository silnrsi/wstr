...
scrpropsortname: Stokoe Notation
---
...
![Stokoe Notation sample](../images/x-stokoe-notation-sample.jpg "From Wikipedia.")
...
<WsList script='x-stokoe-notation' wsMax='5' />
...
- [Full Unicode status for Stokoe Notation](/scrlang/unicode/x-stokoe-notation-unicode)



## Resources

<ArticlesList tag='script-x-stokoe-notation' header='Related articles' />

<SourceLinksList tag='script-x-stokoe-notation' header='External links' entrytype='online' />

<BibList tag='script-x-stokoe-notation' header='Bibliography' entrytype='non-online' />
