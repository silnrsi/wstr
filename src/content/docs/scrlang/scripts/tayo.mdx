...
![Tai Yo script sample](../images/tayo-sample.jpg)
<CaptionText text="Tai Yo sample."/>
<Attribution
    type="Image"
    copyholder="Sầm Công Danh"
    copyurl=""
    copyyears="2022"
...
The Tai Yo script was encoded in The Unicode Standard version 17.0.
...
<ArticlesList tag='script-tayo' header='Related articles' />

<SourceLinksList tag='script-tayo' header='External links' entrytype='online' />

<BibList tag='script-tayo' header='Bibliography' entrytype='non-online' />
