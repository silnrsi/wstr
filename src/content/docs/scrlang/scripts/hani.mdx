...
scrpropotcode: hani
scrpropsortname: Han (Hanzi, Kanji, Hanja)
---
...
![Han script sample](../images/hani-sample.png)
...
<ArticlesList tag='script-hani' header='Related articles' />

<SourceLinksList tag='script-hani' header='External links' entrytype='online' />

<BibList tag='script-hani' header='Bibliography' entrytype='non-online' />
