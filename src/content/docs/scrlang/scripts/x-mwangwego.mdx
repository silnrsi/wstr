...
![Mwangwego script sample](../images/x-mwangwego-sample.png)
...
<WsList script='x-mwangwego' wsMax='5' />
...
- [Full Unicode status for Mwangwego](/scrlang/unicode/x-mwangwego-unicode)



## Resources

<ArticlesList tag='script-x-mwangwego' header='Related articles' />

<SourceLinksList tag='script-x-mwangwego' header='External links' entrytype='online' />

<BibList tag='script-x-mwangwego' header='Bibliography' entrytype='non-online' />
