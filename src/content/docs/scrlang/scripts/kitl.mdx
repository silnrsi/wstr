...
scrpropsortname: Khitan Large script
---
...
![Khitan Large script sample](../images/kitl-sample.jpg)
<CaptionText text="Stone tablet with fake epitaph inscription in the Khitan Large Script."/>
<Attribution
    type="Image"
    copyholder="Babelstone"
    copyurl=""
    copyyears="2016"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:IMU_Khitan_Large_Script_Epitaph_B.jpg"
/>
...
- [Unicode status for Khitan Ideographs](/scrlang/unicode/kitl-unicode)
...
<SourceLinksList tag='script-kitl' header='External links' entrytype='online' />

<BibList tag='script-kitl' header='Bibliography' entrytype='non-online' />
