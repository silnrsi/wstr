...
![Tulu-Tigalari script sample](../images/tutg-sample.jpg)
<CaptionText text="Folio of Sanskrit writing in Tigalari script."/>
<Attribution
    type="Image"
    copyholder="ಶ್ರೀ"
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Tigalari-sanskrit-manuscript.jpg"
/>
...
<SourceLinksList tag='script-tutg' header='External links' entrytype='online' />

<BibList tag='script-tutg' header='Bibliography' entrytype='non-online' />
