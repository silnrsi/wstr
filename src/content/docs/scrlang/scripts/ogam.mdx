...
![Ogham script sample](../images/ogam-sample.png)
<CaptionText text="Ogham inscription Nevern church."/>
<Attribution
    type="Image"
    copyholder="Chris Gunns"
    copyurl=""
    copyyears="2011"
    ...
    author=""
    source="Geograph"
    sourceurl="https://www.geograph.org.uk/photo/544214"
/>
...
<SourceLinksList tag='script-ogam' header='External links' entrytype='online' />
