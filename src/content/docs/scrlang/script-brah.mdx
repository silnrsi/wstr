...
There is some indication that the Eastern Magar [mgp] language is currently using a script called Magar Akkha. However, it appears to be an appropriation of Brahmi.</details>
