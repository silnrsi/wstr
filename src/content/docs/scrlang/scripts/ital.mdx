...
scrpropotcode: ital
scrpropsortname: Old Italic (Etruscan)
---
...
![Old Italic script sample](../images/ital-sample.jpg)
<CaptionText text="Excerpt from a monument inscription in the Etruscan language regarding a legal act between the Velthina and Afuna families."/>
<Attribution
    type="Image"
    copyholder="Sailko"
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/w/index.php?curid=51673403"
/>
...
<SourceLinksList tag='script-ital' header='External links' entrytype='online' />
