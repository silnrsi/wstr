...
![Palmyrene script sample](../images/palm-sample.jpg)
<CaptionText text="Funerary slabstone from Palmyra bearing an inscription, 4 BC."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File%3AInscription_Palmyra_Louvre_AO2205.jpg"
/>
...
<ArticlesList tag='script-palm' header='Related articles' />

<SourceLinksList tag='script-palm' header='External links' entrytype='online' />

<BibList tag='script-palm' header='Bibliography' entrytype='non-online' />
