...
![Eskaya script sample](../images/x-eskaya-sample.png)
...
The Eskaya script is used for writing the [Eskayan](https://www.ethnologue.com/language/esy) language, an artificial language associated with the Eskaya people of the Philippines.
...
<WsList script='x-eskaya' wsMax='5' />
...
- [Full Unicode status for Eskaya](/scrlang/unicode/x-eskaya-unicode)



## Resources

<ArticlesList tag='script-x-eskaya' header='Related articles' />

<SourceLinksList tag='script-x-eskaya' header='External links' entrytype='online' />

<BibList tag='script-x-eskaya' header='Bibliography' entrytype='non-online' />
