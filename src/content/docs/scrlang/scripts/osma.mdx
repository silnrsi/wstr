...
![Osmanya script sample](../images/osma-sample.jpg)
<CaptionText text="Osmaniya or Ciismaniya alphabet, Somalia."/>
<Attribution
    type="Image"
    copyholder="RoboRanks"
    copyurl=""
    copyyears="2007"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Ciismaniya.jpg"
/>
...
<ArticlesList tag='script-osma' header='Related articles' />

<SourceLinksList tag='script-osma' header='External links' entrytype='online' />

<BibList tag='script-osma' header='Bibliography' entrytype='non-online' />
