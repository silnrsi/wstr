...
![Hatran script sample](../images/hatr-sample.jpg)
<CaptionText text="Detail from inscription on marble slab in Hatra, Iraq"/>
<Attribution
    type="Image"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Slab_with_Aramaic_Hatran_Inscription_from_Hatra,_Iraq._Iraq_Museum.jpg"
/>
