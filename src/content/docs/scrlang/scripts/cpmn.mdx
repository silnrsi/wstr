...
![Cypro-Minoan script sample](../images/cpmn-sample.png)
<CaptionText text="Drawing of a Cypro-Minoan clay tablet from Enkomi, Cyprus"/>
<Attribution
    type="Image"
    copyholder="Mikhail Ryazanov"
    copyurl=""
    copyyears="2011"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Enkomi.png"
/>
...
<ArticlesList tag='script-cpmn' header='Related articles' />

<SourceLinksList tag='script-cpmn' header='External links' entrytype='online' />

<BibList tag='script-cpmn' header='Bibliography' entrytype='non-online' />
