...
![Braille script sample](../images/brai-sample.png "Excerpt from Ricci Downard's notes.")
...
<ArticlesList tag='script-brai' header='Related articles' />

<SourceLinksList tag='script-brai' header='External links' entrytype='online' />

<BibList tag='script-brai' header='Bibliography' entrytype='non-online' />
