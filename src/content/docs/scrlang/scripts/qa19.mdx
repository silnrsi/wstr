...
<details>
<summary>Read the full description...</summary>Tikamuli is used primarily in Nepal, and [Jenticha](/scrlang/scripts/sunu) is used primarily in Sikkim. In both places, Sunuwar can also be written in the [Devanagari](/scrlang/scripts/deva) script.
