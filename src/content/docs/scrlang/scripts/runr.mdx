...
![Runic script sample](../images/runr-sample.png)
<CaptionText text="The Rök Runestone, in the Swedish parish of Rök, bears the longest extant Runic inscription c. 800"/>
<Attribution
    type="Image"
    copyholder="Arkland"
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/w/index.php?curid=94104042"
/>
...
- [Full Unicode status for Runic](/scrlang/unicode/runr-unicode)



## Resources

<ArticlesList tag='script-runr' header='Related articles' />

<SourceLinksList tag='script-runr' header='External links' entrytype='online' />

<BibList tag='script-runr' header='Bibliography' entrytype='non-online' />
