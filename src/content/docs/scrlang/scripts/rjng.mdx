...
scrpropotcode: rjng
scrpropsortname: Rejang (Redjang, Kaganga)
---
...
![Kaganga script sample](../images/rjng-sample.png)
<CaptionText text="Sample of Rejang script."/>
<Attribution
    type="Image"
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Redjang_script_sample.svg"
/>
