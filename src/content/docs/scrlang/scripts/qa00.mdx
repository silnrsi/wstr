...
![Bété script sample](../images/qa00-sample.png "Used with permission of Charles Riley. See 'Use and History' tab for more details.")
...
- [Full Unicode status for Bété](/scrlang/unicode/qa00-unicode)



## Resources

<ArticlesList tag='script-qa00' header='Related articles' />

<SourceLinksList tag='script-qa00' header='External links' entrytype='online' />

<BibList tag='script-qa00' header='Bibliography' entrytype='non-online' />
