...
<details>
<summary>Read the full description...</summary>The language has variously been written in the [Balti](/scrlang/scripts/x-balti-a) (sometimes called Balti-A to distinguish it from Balti-B), [Tibetan](/scrlang/scripts/tibt), [Arabic](/scrlang/scripts/arab) and [Devanagari](/scrlang/scripts/deva) scripts, reflecting the multi-ethnic makeup and eventful political history of the region.
...
<WsList script='x-balti-b' wsMax='5' />
...
- [Full Unicode status for Balti-B](/scrlang/unicode/x-balti-b-unicode)



## Resources

<ArticlesList tag='script-x-balti-b' header='Related articles' />

<SourceLinksList tag='script-x-balti-b' header='External links' entrytype='online' />

<BibList tag='script-x-balti-b' header='Bibliography' entrytype='non-online' />
