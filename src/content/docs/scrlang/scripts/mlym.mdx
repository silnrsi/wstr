...
![Malayalam script sample](../images/mlym-sample.png)
<CaptionText text="A letter written in the Malayalam language and script."/>
<Attribution
    type="Image"
    copyholder="unpodimondo"
    copyurl=""
    copyyears="2010"
    ...
    author=""
    source="Flickr"
    sourceurl="https://www.flickr.com/photos/28252455@N08/5150910556/"
/>
...
<ArticlesList tag='script-mlym' header='Related articles' />

<SourceLinksList tag='script-mlym' header='External links' entrytype='online' />

<BibList tag='script-mlym' header='Bibliography' entrytype='non-online' />
