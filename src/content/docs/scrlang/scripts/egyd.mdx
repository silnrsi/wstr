...
scrpropsortname: Egyptian demotic
---
...
![Egyptian demotic script sample](../images/egyd-sample.png)
<Attribution
    type="Image"
    copyholder="Med"
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Louvres-antiquites-egyptiennes-img_2713.jpg"
/>
...
<ArticlesList tag='script-egyd' header='Related articles' />

<SourceLinksList tag='script-egyd' header='External links' entrytype='online' />

<BibList tag='script-egyd' header='Bibliography' entrytype='non-online' />
