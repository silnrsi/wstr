...
scrpropsortname: Syriac (Eastern variant)
---
...
![Syriac script, Eastern variant sample](../images/syrn-sample.png)
<CaptionText text="The Thaksa liturgy for the celebration of the Eucharist in the Chaldean Syrian Church, India."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:East_Syriac_Script_Thaksa.jpg"
/>
...
<ArticlesList tag='script-syrn' header='Related articles' />

<SourceLinksList tag='script-syrn' header='External links' entrytype='online' />

<BibList tag='script-syrn' header='Bibliography' entrytype='non-online' />
