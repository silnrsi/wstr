...
![Kpelle script sample](../images/kpel-sample.png)
<CaptionText text="Kpelle syllabary"/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Kpelle_syllabary.png"
/>
...
<ArticlesList tag='script-kpel' header='Related articles' />

<SourceLinksList tag='script-kpel' header='External links' entrytype='online' />

<BibList tag='script-kpel' header='Bibliography' entrytype='non-online' />
