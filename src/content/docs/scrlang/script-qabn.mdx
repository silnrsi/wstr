...
scrpropisocode: 939 (private use, alias, or special)
...
<li>Symmetry Operator</li>
<li>Non-manual Components</li>
<li>Handshape</li>
<li>Hand Position</li>
<li>Location</li>
<li>Movement</li>
