...
![Bassa Vah script sample](../images/bass-sample.png "Varnie N'jola Karmo, early 1900s.")
...
<ArticlesList tag='script-bass' header='Related articles' />

<SourceLinksList tag='script-bass' header='External links' entrytype='online' />

<BibList tag='script-bass' header='Bibliography' entrytype='non-online' />
