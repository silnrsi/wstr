...
scrpropsortname: Bowen (Lao Baiwen)
---
...
<ArticlesList tag='script-qabe' header='Related articles' />

<SourceLinksList tag='script-qabe' header='External links' entrytype='online' />

<BibList tag='script-qabe' header='Bibliography' entrytype='non-online' />
