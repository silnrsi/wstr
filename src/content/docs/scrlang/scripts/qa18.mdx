...
Tafi is written from left to right. Vowels are not written word-initially; rather, the glottal stop ʔ character precedes any word-initial vowels, as in Arabic. Case is not normally used, but where a capital letter is deemed necessary, the writer can either enlarge the size of the letter or place a circumflex (<Character usv='005E' options='glyph' />) over it.
