...
![Naxi Dongba script sample](../images/nkdb-sample.jpg)
<Attribution
    type="Image"
    copyholder="Someone's Moving Castle"
    copyurl=""
    copyyears="2013"
    ...
    author=""
    source="Wikipedia"
    sourceurl="https://en.wikipedia.org/wiki/File:Lijiang_Bus_with_Chinese_and_Dongba_characters.JPG"
/>
...
<SourceLinksList tag='script-nkdb' header='External links' entrytype='online' />

<BibList tag='script-nkdb' header='Bibliography' entrytype='non-online' />
