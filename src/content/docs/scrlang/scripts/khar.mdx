...
![Kharoshthi script sample](../images/khar-sample.jpg)
<CaptionText text="Wooden Kharosthi document found at Loulan, China by the Hungarian archaeologist Aurel Stein."/>
<Attribution
    type="Image"
    copyholder=""
    copyurl=""
    ...
    author=""
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Loulan_kharosthi_document.jpg"
/>
...
<ArticlesList tag='script-khar' header='Related articles' />

<SourceLinksList tag='script-khar' header='External links' entrytype='online' />

<BibList tag='script-khar' header='Bibliography' entrytype='non-online' />
