...
|copyurl| URL that links to copyright holder information, when present it will format the `copyholder` as a link. Only required when `license` is not "Public Domain". |
...
It can also be used with the `<Caption />` component:
##### Source
