...
Punctuation marks are utilized: the comma and full stop are used and represented by the existing UCS characters; there are also script-qa84ific symbols to indicate questions, reduplication, chanting and intonation. There are different symbols for arithmetic operations such as addition, subtraction, division and multiplication. Furthermore, numerals 0-9 are represented in the Eebee Hmong script. 
