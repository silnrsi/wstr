...
- If the Khitan scripts do not show any significant chronological variation, then perhaps they show a different geographical distribution, with the small script used in one part of the Khitan territory, and the large script in another part of the Khitan territory. But this does not appear to be supported by the distribution of inscriptions (see the map at [Blog from WayBack Machine][wayback-khitan]). Although there does seem to be some clustering of Small script inscriptions, there is no obvious geographical distinction between the two scripts.
...
<CaptionText text='Reference: _What&#x2019;s the Difference_, Andrew West, 2010. [Blog from WayBack Machine](https://web.archive.org/web/20190705221643/http://babelstone.blogspot.com/2010/12/mystery-of-two-khitan-scripts.html)'/>

<Attribution type='Article' copyyears='2010' copyholder='Andrew West' author='' license='' licenseUrl=''/>

<CaptionText text='This article formerly appeared on ScriptSource.'/>

[wayback-khitan]: https://web.archive.org/web/20190705221643/http://babelstone.blogspot.com/2010/12/mystery-of-two-khitan-scripts.html
