...
<span style='color: red'>_Missing image: SinhaV.png_</span>
...
<span style='color: red'>_Missing image: SinhalaHal.png.jpg_</span>
...
- [Full Unicode status for Sinhala](/scrlang/unicode/sinh-unicode.md)
