...
![Gurmukhi script sample](../images/guru-sample.png)
<CaptionText text="Excerpt from Punjabi text in the Gurmukhi script."/>
<Attribution
    type="Image"
    copyholder="OldKnip"
    copyurl=""
    ...
    author=""
    source="Wikipedia"
    sourceurl="https://de.wikipedia.org/w/index.php?title=Datei:Gurmukhi_Text.gif&filetimestamp=20080612190507"
/>
...
<ArticlesList tag='script-guru' header='Related articles' />

<SourceLinksList tag='script-guru' header='External links' entrytype='online' />

<BibList tag='script-guru' header='Bibliography' entrytype='non-online' />
