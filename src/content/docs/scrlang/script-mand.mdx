...
Mandaic writing employs two script-mandific punctuation marks which roughly perform the functions of a full stop and of a comma. These are used infrequently.
</details>
