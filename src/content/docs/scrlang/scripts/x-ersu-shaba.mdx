...
scrpropsortname: Ersu Shaba Picture Writing
---
...
![Ersu Shaba Picture Writing sample](../images/x-ersu-shaba-sample.jpg)
<CaptionText text="Ersu astrological almanac for half of a month, with Ersu Shaba pictographs and explanations in Tibetan."/>
<Attribution
    type="Image"
    license="CC0 1.0"
    author="Babelstone"
    source="Wikimedia"
    sourceurl="https://commons.wikimedia.org/wiki/File:Ersu_astrological_almanac_(3).jpg"
/>
...
<WsList script='x-ersu-shaba' wsMax='5' />

## Unicode status

Ersu Hieroglyphs (or Ersu Shaba Picture Writing) is not yet in Unicode. It is also not yet in the Roadmap to the UCS.

- [Full Unicode status for Ersu](/scrlang/unicode/x-ersu-shaba-unicode)



## Resources

<ArticlesList tag='script-x-ersu-shaba' header='Related articles' />

<SourceLinksList tag='script-x-ersu-shaba' header='External links' entrytype='online' />

<BibList tag='script-x-ersu-shaba' header='Bibliography' entrytype='non-online' />
