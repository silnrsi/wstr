...
* [font.py][ptx-font.py] in the ptxprint repo has a list of “OTFeatNames” which valid features to display in the feature UI. And “OTInternalFeats” are the ones that should _not_ be displayed in a UI. “OTLangs” has a list of OpenType language tags which can be used for selecting a language.
